 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (!heroSlider && document.querySelector(".hero__slider")) heroSlider = new Swiper(".hero__slider", {
            ...
            if (!cardSlider && document.querySelector(".card__slider")) cardSlider = new Swiper(".card__slider", {
            ...
            if (!contentSlider && document.querySelector(".content__slider")) contentSlider = new Swiper(".content__slider", {
                ...
                effect: "fade",
                navigation: {
                    prevEl: ".content .swiper-buttons .swiper-button-prev",
                    nextEl: ".content .swiper-buttons .swiper-button-next"
                },
                autoplay: {
                    delay: 5e3,
                    disableOnInteraction: false,
            ...
            if (window.innerWidth > 767.98) {
                if (!gallerySlider && document.querySelector(".gallery__slider")) gallerySlider = new Swiper(".gallery__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1.05,
...
***************************************************************************** */
        ...
        const gallerySettings = {
            plugins: [ lg_thumbnail_min, lg_zoom_min ],
        ...
        let galleryItems = [];
        function initGallery(galleries, selector = "") {
            if (galleries.length) galleries.forEach((gallery => {
                const settings = selector ? {
                    ...gallerySettings,
                    selector
                } : gallerySettings;
                const galleryInstance = lightgallery_es5(gallery, settings);
        ...
        initGallery(document.querySelectorAll("[data-gallery]"));
        initGallery(document.querySelectorAll(".cashless"), ".img.cashless");
        initGallery(document.querySelectorAll(".terminal"), ".img");
        initGallery(document.querySelectorAll(".roulette"), ".img");
        initGallery(document.querySelectorAll(".system"), ".img");
        initGallery(document.querySelectorAll(".mysterion"), ".img");
        initGallery(document.querySelectorAll(".slots"), ".img");
